...
export async function isBotFromTrustedDomain(ip) {
    ...
    try {
        ...
        const matchingHosts = hostnames.filter(host => domains.some(domain => host.endsWith(domain)));
